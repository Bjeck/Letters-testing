...
*/
	...
	public void GetSceneFunction(string s){ // Javascript then calls this function.
		...
		//like STORY_uhm_1_a
		//but again, it's the URL, but I can't edit that to actually test it.
		//because it still just load the uhm story fully, and reads the appropriate line.

		//there also needs to be a player encoding.
