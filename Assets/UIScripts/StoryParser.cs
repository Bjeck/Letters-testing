...
public class StoryParser : MonoBehaviour {
	...
	public void LoadStory(string nam){
		...
		StreamReader sr = new StreamReader (Application.dataPath + "/Stories/" + nam);  //Why don't I use database instead!!! stories dictionary! 
		string line;																	//because that doesn't have the full string.
